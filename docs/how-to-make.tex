...
\mbox{}\lstinline@{@\\
\mbox{}\lstinline@  @$\langle\,${\itshape loop}\ {\footnotesize \NWlink{nuweb9}{9}}\,$\rangle\,$\verb@@\\
\mbox{}\lstinline@}@\\
\mbox{}{\NWsep}
\end{list}
\vspace{-1ex}
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb6c}{6c}, \NWlink{nuweb7a}{7a}, \NWlink{nuweb8c}{8c}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb5a}{5a}.
\end{list}
\end{minipage}
\end{flushleft}
...
\NWtarget{nuweb9}{}$\langle\,${\itshape loop}\nobreak\ {\footnotesize{9}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{\setlength{\leftmargin}{1em}} \item
